...
namespace ServiceBusProjeto
{
    class Program
    {
        const string QueueConnectionString = "Endpoint=sb://geekburguermarcio.servicebus.windows.net/;SharedAccessKeyName=ProductPolitcs;SharedAccessKey=cyOYn4AZECbFu1McvBM2/eMCFZvhEaQbZ/KgcAqEZrk=;";
        const string QueuePath = "productbus";
